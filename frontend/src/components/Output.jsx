  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center w-full h-[90%] bg-white px-6 py-10 gap-8">
      ...
      <div className="flex flex-col items-center w-full md:w-1/2 bg-gray-50 border rounded-2xl p-6 shadow-sm">
        <h2 className="text-3xl font-bold mb-4 poppins-regular">Your Resume</h2>
      ...
      <div className="flex flex-col items-center w-full md:w-1/2 h-[600px] border rounded-2xl p-6 shadow-sm poppins-regular">
        {fit ? (
          <div className="flex flex-col items-center animate-fadeIn">
            ...
            <p className="text-gray-700 mt-3 text-2xl text-center">
            ...
            <img
              ...
              alt="Congrats doodle"
              className="mt-4 w-72 h-[20rem]"
            />
          </div>
        ) : (
          <div className="flex flex-col items-center animate-fadeIn">
            <XCircle size={60} className="text-red-500 mb-2" />
            <h2 className="text-4xl font-bold text-red-600">Not a Perfect Fit Yet!</h2>
            <p className="text-gray-700 mt-3 text-center text-2xl">
